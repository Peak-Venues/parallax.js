...
; (function ($, window, document, undefined) {
  ...
  function Parallax(element, options) {
    ...
    if (!this.videoSrc && this.$element.is('video')) {
      this.videoSrc = this.$element.first('source').attr('src');
    }
    ...
    this.$slider.addClass('parallax-slider').one('load loadeddata', function () {
      if (!self.naturalHeight || !self.naturalWidth) {
        self.naturalHeight = this.naturalHeight || this.videoHeight || this.height || 1;
        self.naturalWidth = this.naturalWidth || this.videoWidth || this.width || 1;
      }
